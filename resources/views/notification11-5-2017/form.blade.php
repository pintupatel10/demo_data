...
<div @if(old('sms_type') == 'transactional') style="display: block" @else style="display: none" @endif class="form-group{{ $errors->has('transactional_type') ? ' has-error' : '' }}" id="transactional_type">
    <label class="col-sm-3 control-label" for="sms_type">Transactional Type <span class="text-red">*</span></label>
    <div class="col-sm-9">
...
<div  class="form-group{{ $errors->has('notification_to') ? ' has-error' : '' }}">
    <label class="col-sm-3 control-label" for="notification_to">Notification To <span class="text-red">*</span></label>
    <div class="col-sm-9">
