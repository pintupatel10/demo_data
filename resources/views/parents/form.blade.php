...
<div  class="form-group{{ $errors->has('student_id') ? ' has-error' : '' }}">
    <label class="col-sm-4 col-xs-12 control-label" for="student_id">Student <span class="text-red">*</span></label>
    ...
    <div class="col-sm-2">
        ...
        <button style="display: none" type="button" id="btn_done" name="btn_pass" class="btn btn-info pull-right" onclick="hide_suggesion()" >Done</button>
...
<script>
    ...
    function add_student(){
            ...
            newdiv.innerHTML = "<div class='form-group'>" +
                    ...
                    "<div class='col-sm-8'><input type='text' id=\"get_name" + "\"  placeholder='Type Student name' name=\"st_name" + "\"  class='form-control' onKeyUp='CallMorethan3(this.value)' autocomplete='off'></div>";
