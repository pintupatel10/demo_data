        ...
        <section class="content-header">
            ...
            <div class="box">
                ...
                <div class="box-header">
                    <h3 class="box-title"><a href="{{ url('/school/create/') }}" ><button class="btn bg-orange margin" type="button">Add School</button></a></h3>
                </div>
                <!-- /.box-header -->
                        ...
                        @foreach ($list as $list)
                            <tr>
                                ...
                                <td><div class="btn-group-horizontal">
                                        ...
                                        {{ Form::open(array('route' => array('school.show', $list['id']), 'method' => 'get','style'=>'display:inline')) }}
                                        <button class="btn btn-info" type="submit" ><i class="fa fa-eye"></i></button>
                                        {{ Form::close() }}

                                        {{ Form::open(array('route' => array('school.edit', $list['id']), 'method' => 'get','style'=>'display:inline')) }}
                            ...
                            <div id="myModal{{$list['id']}}" class="fade modal modal-danger" role="dialog" >
                                {{ Form::open(array('route' => array('school.destroy', $list['id']), 'method' => 'delete','style'=>'display:inline')) }}
