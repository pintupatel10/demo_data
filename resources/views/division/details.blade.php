        ...
        <section class="content-header">
            ...
            <div class="box">
                ...
                <div class="box-header">
                    <h3 class="box-title"><a href="{{ url('/division/create/') }}" ><button class="btn bg-orange margin" type="button">Add DIVISION</button></a></h3>
                </div>
                <!-- /.box-header -->
                        ...
                        @foreach ($division as $list)
                            <tr>
                                ...
                                <td><div class="btn-group-horizontal">
                                        ...
                                        {{ Form::open(array('route' => array('division.show', $list['id']), 'method' => 'get','style'=>'display:inline')) }}
                                        <button class="btn btn-info" type="submit" ><i class="fa fa-eye"></i></button>
                                        {{ Form::close() }}

                                        {{ Form::open(array('route' => array('division.edit', $list['id']), 'method' => 'get','style'=>'display:inline')) }}
                            ...
                            <div id="myModal{{$list['id']}}" class="fade modal modal-danger" role="dialog" >
                                {{ Form::open(array('route' => array('division.destroy', $list['id']), 'method' => 'delete','style'=>'display:inline')) }}
