    ...
    <div id="panel-device">
        <div class="form-group{{ $errors->has('device') ? ' has-error' : '' }}">
            ...
            <div class="col-sm-4">
                    {!! Form::select('device',[''=>'Please Select']+$device,!empty(\Illuminate\Support\Facades\Input::get('device'))?\Illuminate\Support\Facades\Input::get('device'):null,['id'=>'device','class' => 'select2 select2-hidden-accessible form-control', 'style' => 'width: 100%']) !!}
