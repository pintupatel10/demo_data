    ...
    <div class="form-group{{ $errors->has('report_type') ? ' has-error' : '' }}">
        ...
        <div class="col-sm-4">
            {!! Form::select('report_type_staff', $reports_staff, null, ['id'=>'report_type_staff','class' => 'select2 form-control', 'style' => 'width: 100%']) !!}
    ...
    @if(Auth::user()->role=="admin")
        <div class="form-group{{ $errors->has('staff_school_id') ? ' has-error' : '' }}">
            ...
            <div class="col-sm-4">
                {!! Form::select('staff_school_id',[''=>'Please Select']+$school_name,!empty(\Illuminate\Support\Facades\Input::get('staff_school_id'))?\Illuminate\Support\Facades\Input::get('school_id'):null,['id'=>'staff_school_id','class' => 'select2 select2-hidden-accessible form-control', 'style' => 'width: 100%','onchange'=> 'get_Device(this.value);']) !!}
        ...
        <div class="{{ $errors->has('date_staff') ? ' has-error' : '' }}">
            ...
            <div class="col-sm-4">
                <div class="input-group">
                    ...
                    {!! Form::text('date_staff', null, ['class' => 'form-control', 'id'=>'datepicker3']) !!}
                </div>
    ...
    <div id="panel-monthstaff" class="form-group">
        <div class="{{ $errors->has('month') ? ' has-error' : '' }}">
            ...
            <div class="col-sm-4">
                <div class="input-group">
                    <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                    {!! Form::text('month_staff', null, ['class' => 'form-control', 'id'=>'monthpicker1']) !!}
                </div>
                @if ($errors->has('month'))
                    <span class="help-block">
    ...
    <div id="panel-yearstaff" class="form-group">
        <div class="{{ $errors->has('yearfrom') ? ' has-error' : '' }}">
            ...
            <div class="col-sm-4">
                <div class="input-group">
                    <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                    {!! Form::text('yearfrom_staff', null, ['class' => 'form-control', 'id'=>'yearfrom1']) !!}
    ...
    <div id="panel-device_staff">
        ...
        <div class="form-group{{ $errors->has('device_staff') ? ' has-error' : '' }}">
            ...
            <div class="col-sm-4">
                    {!! Form::select('device_staff',[],!empty(\Illuminate\Support\Facades\Input::get('device_staff'))?\Illuminate\Support\Facades\Input::get('device_staff'):null,['id'=>'device_staff','class' => 'select2 select2-hidden-accessible form-control', 'style' => 'width: 100%']) !!}
        ...
        <div class="form-group {{ $errors->has('staff_date_from') ? ' has-error' : '' }}">
            ...
            <div class="col-sm-4">
                <div class="input-group">
                    <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                    {!! Form::text('staff_date_from', null, ['class' => 'form-control', 'id'=>'datepicker4']) !!}
                </div>
        ...
        <div class="form-group {{ $errors->has('staff_date_to') ? ' has-error' : '' }}">
            ...
            <div class="col-sm-4">
                <div class="input-group">
                    <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                    {!! Form::text('staff_date_to', null, ['class' => 'form-control', 'id'=>'datepicker5']) !!}
                </div>
