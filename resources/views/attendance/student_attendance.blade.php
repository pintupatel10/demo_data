    ...
    <div class="box-header with-border">
        ...
        <div class="pull-right">
            ...
            <div class="form-group">
                        ...
                        <input  class="form-control" type="text" @if(!empty($search)) value="{{$search}}" @else placeholder="Search" @endif name="search_student" id="search_student">
                            </span>
                        <span class=" col-sm-3 col-xs-3">
                            <button class="btn btn-info pull-right" type="button" onclick="search_student()">Search</button>
                        </span>
            </div>
            {{--</div>--}}
        </div>
    ...
    <div class="box-body table-responsive">
        ...
        <table id="" class="table table-bordered table-striped">
            ...
            @foreach ($student as  $list)
                ...
                $check_leave = in_array($list['id'],$leave_list);
                ?>

                @if($check_present || $check_leave )
                    <?php
...
<script>
    function search_student(){
        //filter_form
       var search_student =document.getElementById('search_student').value;
        var school_id=document.getElementById('school_id').value;
        var class_id=document.getElementById('class_id').value;
        var division=document.getElementById('class_division').value;
        var date=document.getElementById('datepicker').value;
        window.location = 'attendance?school_id=' + school_id+'&class_name='+class_id+'&class_division='+division+'&date='+date +'&submit=submit'+'&search_student='+search_student;
    }
</script>